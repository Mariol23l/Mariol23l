...
class ventaProducto{
    ...
    function buscar_detVenta($id_venta){
        $sql = "SELECT venta_producto.precio_venta as preventa, venta_producto.igv as igvp, cantidad,producto.nombre as nombre ,lote.lote as LOTE, concentracion, laboratorio.nombre as laboratorio, presentacion.nombre as presentacion, subtotal,vencimiento
        FROM venta_producto
