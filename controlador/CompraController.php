...
if ($_POST['funcion']=='registrar_compra') {
    ...
    try {
        ...
        foreach ($productos as $prod) {
            ...
            $psigv=number_format($prod->precio/1.18,8);
            $subtotal=$prod->cantidad*$prod->precio;
            $conexion->exec("INSERT INTO venta_producto(precio_venta,igv,cantidad,subtotal,lote_id_lote,venta_id_venta) values('$prod->precio', '$psigv','$prod->cantidad', '$subtotal','$prod->id','$id_venta')");
        }
        $conexion->commit();
